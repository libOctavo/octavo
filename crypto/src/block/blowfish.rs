...
impl Blowfish {
    ...
    pub fn init() -> Self {
        Blowfish {
            p: [0x243f6a88, 0x85a308d3, 0x13198a2e, 0x03707344, 0xa4093822, 0x299f31d0, 0x082efa98,
    ...
    #[doc(hidden)]
    pub fn expand_key(mut self, key: &[u8]) -> Self {
    ...
    #[doc(hidden)]
    pub fn salted_expand_key(mut self, salt: &[u8], key: &[u8]) -> Self {
    ...
    #[doc(hidden)]
    pub fn encrypt_round(&self, block: (u32, u32)) -> (u32, u32) {
